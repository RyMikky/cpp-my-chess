...
public:
	...
	void GetPlayerTotalMoveCount(BaseFigureColor color);

	void PlayerMove(std::string label, BaseFigureColor color, const int& x1, const int& y1, const int& x2, const int& y2);
