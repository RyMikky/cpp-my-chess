...
int main() {
	...
	*/
	...
	chess::resource::King white_king;
	white_king.set_color(chess::resource::FigureColor::white).set_id(1).set_in_game().render_figure();

	chess::resource::Solder black_solder;
	black_solder.set_color(chess::resource::FigureColor::black).set_id(2).set_in_game().render_figure();
	black_solder.exchange_figure(chess::resource::FigureType::king);
